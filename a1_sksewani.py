...
Program: a1_sksewani.py (replace sksewani with your Seneca User name)
Author: SUMAN SEWANI
The python code in this file (a1_sksewani.py) is original work written by
"SUMAN SEWANI". No code in this file is copied from any other source
...
def usage():
    ...
    return 'Usage: a1_sksewani.py YYYYMMDD|YYYY/MM/DD|YYYY-MM-DD|YYYY.MM.DD'
